...
public class vp_Attempt<V> : vp_Attempt
{
	...
	protected override void InitFields()
	{
		...
		{
			GetStaticGenericMethod(GetType(), "AlwaysOK", m_ArgumentType, typeof(bool))
		};
	...
	public override void Register(object t, string m, int v)
	{
		...
		{
			UnityEngine.Debug.LogWarning("Warning: Event '" + base.EventName + "' of type (vp_Attempt) targets multiple methods. Events of this type must reference a single method (only the last reference will be functional).");
		}
		if (m != null)
		{
