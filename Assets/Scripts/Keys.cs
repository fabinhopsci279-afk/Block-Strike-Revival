...
public class Keys
{
	...
	private static bool isOSX => Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.OSXPlayer || Application.platform == RuntimePlatform.WebGLPlayer;
	...
	public static string XboxLStickLeft => "Joy Axis 1-";

	public static string XboxLStickRight => "Joy Axis 1+";

	public static string XboxLStickUp => "Joy Axis 2-";

	public static string XboxLStickDown => "Joy Axis 2+";
	...
	public static string Xbox1LStickLeft => "Joy1 Axis 1-";

	public static string Xbox1LStickRight => "Joy1 Axis 1+";

	public static string Xbox1LStickUp => "Joy1 Axis 2-";

	public static string Xbox1LStickDown => "Joy1 Axis 2+";
	...
	public static string Xbox2LStickLeft => "Joy2 Axis 1-";

	public static string Xbox2LStickRight => "Joy2 Axis 1+";

	public static string Xbox2LStickUp => "Joy2 Axis 2-";

	public static string Xbox2LStickDown => "Joy2 Axis 2+";
	...
	public static string Xbox3LStickLeft => "Joy3 Axis 1-";

	public static string Xbox3LStickRight => "Joy3 Axis 1+";

	public static string Xbox3LStickUp => "Joy3 Axis 2-";

	public static string Xbox3LStickDown => "Joy3 Axis 2+";
	...
	public static string Xbox4LStickLeft => "Joy4 Axis 1-";

	public static string Xbox4LStickRight => "Joy4 Axis 1+";

	public static string Xbox4LStickUp => "Joy4 Axis 2-";

	public static string Xbox4LStickDown => "Joy4 Axis 2+";
