...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
	...
	protected internal string mAppVersionPun => string.Format("{0}_{1}", PhotonNetwork.gameVersion, "1.65");
	...
	public bool IsAuthorizeSecretAvailable => CustomAuthenticationValues != null && !string.IsNullOrEmpty(CustomAuthenticationValues.Token);
	...
	public bool ConnectToRegionMaster(CloudRegionCode region)
	{
		...
		if (State == global::PeerState.ConnectedToNameServer)
		{
			object authenticationValues = CustomAuthenticationValues;
	...
	private void RebuildPlayerListCopies()
	{
		...
		PhotonPlayer[] array2 = mPlayerListCopy;
		foreach (PhotonPlayer photonPlayer2 in array2)
		{
			str += ((photonPlayer2 == null) ? "null" : photonPlayer2.name);
		}
	...
	public void OnStatusChanged(StatusCode statusCode)
	{
		...
		case StatusCode.Connect:
			...
			{
				object authenticationValues4 = CustomAuthenticationValues;
				...
				AuthenticationValues authValues3 = (AuthenticationValues)authenticationValues4;
		...
		case StatusCode.EncryptionEstablished:
			...
			{
				object authenticationValues3 = CustomAuthenticationValues;
				...
				AuthenticationValues authValues2 = (AuthenticationValues)authenticationValues3;
	...
	public void OnEvent(EventData photonEvent)
	{
		...
		case 209:
		{
			...
			int num2 = array[0];
			int num3 = array[1];
			UnityEngine.Debug.Log("Ev OwnershipRequest: " + photonEvent.Parameters.ToStringFull() + " ViewID: " + num2 + " from: " + num3 + " Time: " + Environment.TickCount % 1000);
			...
			UnityEngine.Debug.Log("Ev OwnershipRequest PhotonView.ownershipTransfer: " + photonView.ownershipTransfer + " .ownerId: " + photonView.ownerId + " isOwnerActive: " + photonView.isOwnerActive + ". This client's player: " + PhotonNetwork.player.ToStringFull());
		...
		case 206:
		{
			...
			for (short num6 = num5; num6 < hashtable3.Count; num6 = (short)(num6 + 1))
			{
		...
		case 204:
		{
			...
			{
				UnityEngine.Debug.LogError("Ev Destroy Failed. Could not find PhotonView with instantiationId " + num4 + ". Sent by actorNr: " + num);
			}
			return;
		}
		case 208:
	...
	public void RunViewUpdate()
	{
		if (PhotonNetwork.connected && !PhotonNetwork.offlineMode && mActors != null && mActors.Count > 1)
		{
			...
			{
				PhotonView value = photonView.Value;
				if (value.synchronization != 0 && value.isMine && value.gameObject.activeInHierarchy && !blockSendingGroups.Contains(value.group))
				{
	...
	private void OnSerializeRead(ExitGames.Client.Photon.Hashtable data, PhotonPlayer sender, int networkTime, short correctPrefix)
	{
		...
		else
		{
			...
			{
				UnityEngine.Debug.Log("Adjusting owner to sender of updates. From: " + photonView.ownerId + " to: " + sender.ID);
				photonView.ownerId = sender.ID;
			}
			object[] incomingData = data[(byte)1] as object[];
			PhotonStream stream = new PhotonStream(write: false, incomingData);
