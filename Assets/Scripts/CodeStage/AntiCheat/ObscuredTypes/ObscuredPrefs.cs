...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	public static class ObscuredPrefs
	{
		...
		private static string encryptionKey = "e604f3";
		...
		public static int GetInt(string key, int defaultValue)
		{
			...
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptIntValue(key, encryptedPrefsString, defaultValue);
		}
		...
		public static uint GetUInt(string key, uint defaultValue)
		{
			...
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptUIntValue(key, encryptedPrefsString, defaultValue);
		}
		...
		public static string GetString(string key, string defaultValue)
		{
			...
			string encryptedPrefsString = GetEncryptedPrefsString(key, text);
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptStringValue(key, encryptedPrefsString, defaultValue);
		}
		...
		public static float GetFloat(string key, float defaultValue)
		{
			...
			string encryptedPrefsString = GetEncryptedPrefsString(key, text);
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptFloatValue(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptDoubleValue(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptLongValue(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptBoolValue(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptVector2Value(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptVector3Value(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptQuaternionValue(key, encryptedPrefsString, defaultValue);
		}
		...
		{
			string encryptedPrefsString = GetEncryptedPrefsString(key, EncryptKey(key));
			return (encryptedPrefsString == "{not_found}") ? defaultValue : DecryptRectValue(key, encryptedPrefsString, defaultValue);
		}
